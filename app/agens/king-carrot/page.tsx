...
const stats = [
  { label: "KODENAVN", value: "KING CARROT" },
  { label: "STATUS", value: "AKTIV" },
  { label: "CLEARANCE", value: "LEVEL 5" },
  { label: "MISSIONER", value: "KLASSIFICERET" },
];

export default function KingCarrotPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="mb-8">
          <YouTubeEmbed videoId="q8OhIcrV-XQ" autoplay title="King Carrot Briefing" />
        </div>

        <div className="mt-8 text-center text-green-800 text-xs">
          [KING CARROT — DOSSIER SLUT — KLASSIFICERET]
        </div>
      </div>
    </div>
  );
